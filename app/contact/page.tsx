...
export default function ContactPage() {
  ...
  const [form, setForm] = useState<Record<FieldName, string>>({
    name: '', email: '', org: '', services: '', message: '',
  });
  ...
  return (
    <main className="min-h-screen bg-[var(--dark)] text-white">
      <div className="px-5 sm:px-10 md:px-16 lg:px-24 xl:px-40">
        ...
        <div
          className="pt-[clamp(100px,16vh,200px)]"
          style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: '0 80px', alignItems: 'start' }}
        >
          {/* ── LEFT: heading + form ── */}
          <div>
            ...
            {sent ? (
              <div className="py-16 text-center">
                ...
                <p className="text-white/50 font-light" style={{ fontSize: 'clamp(1rem, 1.5vw, 1.2rem)' }}>
